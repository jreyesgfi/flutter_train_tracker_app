...
import 'package:gymini/presentation_layer/services/SessionDataToTileService.dart';
...
final trainingScreenProvider =
  ...
  final tileService = ref.read(sessionDataToTileServiceProvider);
  return TrainingScreenNotifier(ref, tileService);
});
