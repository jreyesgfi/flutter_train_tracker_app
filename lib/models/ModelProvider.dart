...
import 'MuscleData.dart';
import 'SessionData.dart';

export 'ExerciseData.dart';
export 'MuscleData.dart';
export 'SessionData.dart';

class ModelProvider implements amplify_core.ModelProviderInterface {
  @override
  String version = "868721fde8c74a64e18d979558b98e0b";
  @override
  ...
  amplify_core.ModelType getModelTypeByModelName(String modelName) {
    switch(modelName) {
      case "ExerciseData":
        return ExerciseData.classType;
      case "MuscleData":
        return MuscleData.classType;
      case "SessionData":
